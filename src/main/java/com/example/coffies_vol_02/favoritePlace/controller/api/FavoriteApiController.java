...
public class FavoriteApiController {
    ...
    public CommonResponse<Page<FavoritePlaceResponseDto>>MyWishList(@ApiIgnore @PageableDefault(size = 5,sort = "id",direction= Sort.Direction.DESC) Pageable pageable, 
                                                                   @Parameter(name = "user_id",description = "회원의 아이디",required = true) @PathVariable("user_id")String userId){
    ...
    public CommonResponse<?>wishListCheck(@Parameter(name = "member_id",description = "회원 아이디") @PathVariable("member_id")String memberId,
                                          @Parameter(name = "place_id",description = "가게 번호") @PathVariable("place_id") Integer placeId,
    ...
    public CommonResponse<?>wishListAdd(@Parameter(name = "member_id",description = "회원의 번호",required = true) @PathVariable("member_id")Integer memberId,
                                        @Parameter(name = "place_id",description = "가게의 번호",required = true)@PathVariable("place_id") Integer placeId){
        try{
    ...
    public CommonResponse<String>wishListDelete(@Parameter(name = "place_id",description = "가게의 번호",required = true)@PathVariable("place_id")Integer placeId){
        try{
    ...
    public CommonResponse<Page<BoardResponse>>MyArticle(@Parameter(name = "id",description = "회원의 아이디",required = true)@PathVariable("id") String userId,@ApiIgnore @PageableDefault(size = 5,sort = "id",direction = Sort.Direction.DESC) Pageable pageable){
    ...
    public CommonResponse<List<placeCommentResponseDto>>MyComment(@Parameter(name = "id",description = "회원의 아이디",required = true) @PathVariable("id") String userId,@ApiIgnore @PageableDefault Pageable pageable){
