...
public class LikeApiController {
    ...
    public CommonResponse<?>createLike(@Parameter(name = "board_id",description = "게시글의 번호",required = true) @PathVariable("board_id")Integer boardId,
    ...
    public CommonResponse<String>boardLikeCancel(@Parameter(name = "board_id",description = "게시글의 번호",required = true) @PathVariable("board_id")Integer boardId,
                                                 @ApiIgnore @AuthenticationPrincipal CustomUserDetails customUserDetails){
    ...
    public CommonResponse<List<String>>boardLikeCount(@Parameter(name = "board_id",description = "게시글의 번호",required = true) @PathVariable("board_id")Integer boardId,
    ...
    public CommonResponse<?>commentLikePlus(@Parameter(name = "place_id",description = "가게의 번호",required = true) @PathVariable("place_id")Integer placeId,
    ...
    public CommonResponse<?>commentLikeMinus(@Parameter(name = "place_id",description = "가게의 번호",required = true) @PathVariable("place_id")Integer placeId,
                                             @Parameter(name = "reply_id",description = "댓글의 번호",required = true) @PathVariable("reply_id")Integer replyId,
                                             @ApiIgnore @AuthenticationPrincipal CustomUserDetails customUserDetails){
    ...
    public CommonResponse<List<String>>commentLikeCount(@Parameter(name = "reply_id",description = "댓글의 번호",required = true) @PathVariable("reply_id")Integer replyId,
                                                        @ApiIgnore @AuthenticationPrincipal CustomUserDetails customUserDetails){
