...
public class Member extends BaseTime {
    ...
    private Role role;
    @Builder
    public Member(Integer id,String userId,String password,String memberName,String userPhone,String userGender,Integer userAge,String userEmail,String userAddr1,String userAddr2,Role role){
        this.id = id;
        this.userId = userId;
